...
const u8 sChozodia_57_Clipdata[542] = INCBIN_U8("data/rooms/chozodia/Chozodia_57_Clipdata.gfx");

const u8 sChozodia_57_Bg2[128] = INCBIN_U8("data/rooms/chozodia/Chozodia_57_Bg2.gfx");

const u8 sChozodia_57_Bg1[1626] = INCBIN_U8("data/rooms/chozodia/Chozodia_57_Bg1.gfx");

...
const u16 sMorphBallLauncherOam_Idle_Frame0[OAM_DATA_SIZE(12)] = {
    0xc,
...
const u16 sMorphBallLauncherOam_Idle_Frame1[OAM_DATA_SIZE(15)] = {
    0xf,
...
const u16 sMorphBallLauncherOam_Idle_Frame2[OAM_DATA_SIZE(15)] = {
    0xf,
...
const u16 sMorphBallLauncherOam_Launching_Frame0[OAM_DATA_SIZE(13)] = {
    0xd,
    OBJ_SHAPE_HORIZONTAL | 0x8, 0x1f8, OBJ_SPRITE_OAM | 0x20f,
    OBJ_SHAPE_HORIZONTAL | 0x0, 0x1f4, OBJ_SPRITE_OAM | 0x222,
    0x0, OBJ_X_FLIP | 0x4, OBJ_SPRITE_OAM | 0x222,
...
const u16 sMorphBallLauncherOam_Launching_Frame1[OAM_DATA_SIZE(15)] = {
    0xf,
...
const u16 sMorphBallLauncherOam_Launching_Frame2[OAM_DATA_SIZE(15)] = {
    0xf,
...
const u16 sMorphBallLauncherOam_Launching_Frame3[OAM_DATA_SIZE(15)] = {
    0xf,
...
const u16 sMorphBallLauncherOam_Launching_Frame4[OAM_DATA_SIZE(15)] = {
    0xf,
...
const u16 sMorphBallLauncherPartOam_Back_Frame0[OAM_DATA_SIZE(4)] = {
    0x4,
...
const u16 sMorphBallLauncherPartOam_Energy_Frame0[OAM_DATA_SIZE(1)] = {
    0x1,
    0xec, 0x1ec, OBJ_SPRITE_OAM | 0x213
};

const u16 sMorphBallLauncherPartOam_Energy_Frame1[OAM_DATA_SIZE(2)] = {
    0x2,
    0xee, 0x1ee, OBJ_SPRITE_OAM | 0x214,
    0xec, OBJ_X_FLIP | 0xc, OBJ_SPRITE_OAM | 0x213
};

const u16 sMorphBallLauncherPartOam_Energy_Frame2[OAM_DATA_SIZE(4)] = {
    0x4,
...
const u16 sMorphBallLauncherPartOam_Energy_Frame3[OAM_DATA_SIZE(7)] = {
    0x7,
...
const u16 sMorphBallLauncherPartOam_Energy_Frame4[OAM_DATA_SIZE(7)] = {
    0x7,
...
const u16 sMorphBallLauncherPartOam_Energy_Frame5[OAM_DATA_SIZE(9)] = {
    0x9,
...
const u16 sMorphBallLauncherPartOam_Energy_Frame6[OAM_DATA_SIZE(9)] = {
    0x9,
...
const u16 sMorphBallLauncherPartOam_Energy_Frame7[OAM_DATA_SIZE(6)] = {
    0x6,

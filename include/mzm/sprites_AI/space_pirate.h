...
#define SPACE_PIRATE_POSE_0xE 0xE
#define SPACE_PIRATE_POSE_0xF 0xF
#define SPACE_PIRATE_POSE_0x10 0x10
#define SPACE_PIRATE_POSE_0x11 0x11
...
#define SPACE_PIRATE_POSE_0x1A 0x1A
#define SPACE_PIRATE_POSE_0x1C 0x1C
...
#define SPACE_PIRATE_POSE_0x2A 0x2A
#define SPACE_PIRATE_POSE_0x2B 0x2B
...
enum SpacePirateAim {
    SPACE_PIRATE_AIM_FORWARD,
    SPACE_PIRATE_AIM_DIAGONALLY_UP,
    SPACE_PIRATE_AIM_DIAGONALLY_DOWN
};

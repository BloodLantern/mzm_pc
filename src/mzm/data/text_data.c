...
const u16 sJapaneseText_Message_ZebesEscape[] = INCTEXT("{WIDTH(76)}自爆装置作動！\n{WIDTH(88)}脱出せよ！");
const u16 sJapaneseText_Message_ChozodiaEscape[] = INCTEXT("{WIDTH(76)}自爆装置作動！\n{WIDTH(88)}脱出せよ！");
...
const u16 sJapaneseText_Location_Mothership[] = INCTEXT("{WIDTH(47)}スペースパイレーツ　マザーシップ");
...
const u16 sJapaneseText_Location_Unused8[] = INCTEXT("{WIDTH(97)}空き８");
const u16 sJapaneseText_Location_Unused9[] = INCTEXT("{WIDTH(97)}空き９");
const u16 sJapaneseText_Location_Unused10[] = INCTEXT("{WIDTH(93)}空き１０");
const u16 sJapaneseText_Location_Unused11[] = INCTEXT("{WIDTH(93)}空き１１");
const u16 sJapaneseText_Location_Unused12[] = INCTEXT("{WIDTH(93)}空き１２");
const u16 sJapaneseText_Location_Unused13[] = INCTEXT("{WIDTH(93)}空き１３");
const u16 sJapaneseText_Location_Unused14[] = INCTEXT("{WIDTH(93)}空き１４");
const u16 sJapaneseText_Location_Unused15[] = INCTEXT("{WIDTH(93)}空き１５");
...
const u16 sHiraganaText_Message_UnknownItemPlasma[] = INCTEXT("{WIDTH(56)}{COLOR(5)}なにか　わからない　アイテム\n{WIDTH(110)}");
...
const u16 sHiraganaText_Message_UnknownItemGravity[] = INCTEXT("{WIDTH(56)}{COLOR(5)}なにか　わからない　アイテム\n{WIDTH(110)}");
...
const u16 sHiraganaText_Message_UnknownItemSpaceJump[] = INCTEXT("{WIDTH(56)}{COLOR(5)}なにか　わからない　アイテム\n{WIDTH(110)}");
const u16 sHiraganaText_Message_PowerGrip[] = INCTEXT("{WIDTH(82)}{COLOR(5)}パワーグリップ\n{WIDTH(110)}");
const u16 sHiraganaText_Message_SavePrompt[] = INCTEXT("{WIDTH(78)}セーブしますか？\n{WIDTH(90)}{INDENT(64)}はい{INDENT(160)}いいえ");
const u16 sHiraganaText_Message_SaveComplete[] = INCTEXT("{WIDTH(82)}セーブしました\n{WIDTH(110)}");
const u16 sHiraganaText_Message_WeaponResupplyComplete[] = INCTEXT("{WIDTH(98)}ぶきが\n{WIDTH(56)}ぜんぶ　ほきゅう　されました");
const u16 sHiraganaText_Message_EnergyTankRechargeComplete[] = INCTEXT("{WIDTH(86)}たいりょくが\n{WIDTH(56)}ぜんぶ　かいふく　されました");
const u16 sHiraganaText_Message_WeaponsAndEnergyRestored[] = INCTEXT("{WIDTH(71)}ぶきも　たいりょくも\n{WIDTH(56)}ぜんぶ　かいふく　されました");
const u16 sHiraganaText_Message_BrinstarMap[] = INCTEXT("{WIDTH(35)}{COLOR(9)}ブリンスタ{COLOR(0)}の{COLOR(5)}マップデータ{COLOR(0)}を　てにいれた\n{WIDTH(110)}");
const u16 sHiraganaText_Message_KraidMap[] = INCTEXT("{WIDTH(39)}{COLOR(8)}クレイド{COLOR(0)}の{COLOR(5)}マップデータ{COLOR(0)}を てにいれた\n{WIDTH(110)}");
const u16 sHiraganaText_Message_NorfairMap[] = INCTEXT("{WIDTH(35)}{COLOR(6)}ノルフェア{COLOR(0)}の{COLOR(5)}マップデータ{COLOR(0)}を　てにいれた\n{WIDTH(110)}");
const u16 sHiraganaText_Message_RidleyMap[] = INCTEXT("{WIDTH(39)}{COLOR(7)}リドリー{COLOR(0)}の{COLOR(5)}マップデータ{COLOR(0)}を　てにいれた\n{WIDTH(110)}");
const u16 sHiraganaText_Message_MotherShipMap[] = INCTEXT("{WIDTH(23)}{COLOR(10)}うちゅうかいぞくせん{COLOR(0)}の{COLOR(5)}マップデータ{COLOR(0)}を　とった\n{WIDTH(110)}");
const u16 sHiraganaText_Message_FullyPoweredSuit[] = INCTEXT("{WIDTH(35)}でんせつの{COLOR(5)}パワードスーツ{COLOR(0)}を　てにいれた\n{WIDTH(110)}");
const u16 sHiraganaText_Message_ZebesEscape[] = INCTEXT("{WIDTH(67)}じばくそうち　さどう！\n{WIDTH(78)}だっしゅつせよ！");
const u16 sHiraganaText_Message_ChozodiaEscape[] = INCTEXT("{WIDTH(67)}じばくそうち　さどう！\n{WIDTH(78)}だっしゅつせよ！");
...
const u16 sHiraganaText_Location_Unused8[] = INCTEXT("{WIDTH(97)}空き８");
const u16 sHiraganaText_Location_Unused9[] = INCTEXT("{WIDTH(97)}空き９");
const u16 sHiraganaText_Location_Unused10[] = INCTEXT("{WIDTH(93)}空き１０");
const u16 sHiraganaText_Location_Unused11[] = INCTEXT("{WIDTH(93)}空き１１");
const u16 sHiraganaText_Location_Unused12[] = INCTEXT("{WIDTH(93)}空き１２");
const u16 sHiraganaText_Location_Unused13[] = INCTEXT("{WIDTH(93)}空き１３");
const u16 sHiraganaText_Location_Unused14[] = INCTEXT("{WIDTH(93)}空き１４");
const u16 sHiraganaText_Location_Unused15[] = INCTEXT("{WIDTH(93)}空き１５");
...
const u16 sEnglishText_Message_PowerBombTankAcquired[] = INCTEXT("{WIDTH(65)}{COLOR(5)}Power Bomb Tank\n{WIDTH(26)}{COLOR(0)}Power Bomb capacity increased.");
...
const u16 sEnglishText_Message_WeaponResupplyComplete[] = INCTEXT("{WIDTH(68)}Weapons system\n{WIDTH(61)}resupply complete.");
